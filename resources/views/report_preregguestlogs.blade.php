...
<script type="text/javascript">
  $(function() {
          var table = $('#mytable').DataTable({
             ...
             // lengthChange: false,
             buttons: [
                { extend: 'print', className: 'd-none', title:'Pre-Registered Guest List', exportOptions:{ columns:[0, 1, 2, 3, 4, 5, 6, 7, 8]} },
                { extend: 'excel', className: 'd-none', title:'Pre-Registered Guest List', exportOptions:{ columns:[0, 1, 2, 3, 4, 5, 6, 7, 8]} },
                'pageLength',
             ],
